...
<title>Trainer Login - Driving School Arena</title>
...
.trainer-login-hero { /* Specific gradient for Trainer Login page hero */
    background: linear-gradient(135deg, #009688, #4DB6AC); /* Teal/Green gradient */
}
...
/* --- Form Page Container (for Trainer Login) --- */
...
.form-heading { /* Replaces H2 for consistent styling */
    margin-bottom: 30px;
    color: var(--text-light);
    font-family: var(--font-serif);
    font-weight: bold;
...
<body style="background-color: #C19A6B;">
    ...
    <!-- Hero Section for Trainer Login Page -->
    <div class="page-hero-container trainer-login-hero">
        <div class="hero-content">
            <h1 class="page-hero-title animate__animated animate__fadeInDown">Trainer Login</h1>
            <p class="page-hero-subtitle animate__animated animate__fadeInUp animate__delay-0.5s">Access your trainer dashboard.</p>
        </div>
    </div>
    ...
    <div class="form-page-container">
        <div class="form-wrapper animate__animated" data-animation="animate__fadeInUp">
            <h2 class="form-heading">Trainer Login Here</h2>
            
            <form method="post" action="/Drivingmitra/trainer_login" novalidate class="needs-validation">
                <div class="form-group">
                    <label for="trainer-id">Login ID:</label>
                    <input type="text" id="trainer-id" name="trainer-id" placeholder="Login ID" required>
