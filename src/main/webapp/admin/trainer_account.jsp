...
<title>Add Trainer Account - Driving School Arena</title>
...
.form-group-admin input[type="email"]:focus,
...
.form-group-admin input[type="radio"] {
    margin-right: 8px;
...
.alert-message {
    ...
    text-align: center;
    color: var(--admin-text-light);
    background-color: var(--admin-accent-color); /* A default alert color, can be customized */
...
%>
    ...
    <div class="admin-hero-container">
        <div class="admin-hero-content">
            <h1 class="admin-hero-title animate__animated animate__fadeInDown">Add New Instructor</h1>
            <p class="admin-hero-subtitle animate__animated animate__fadeInUp animate__delay-0.5s">Register new trainers to the system.</p>
        </div>
    </div>
	...
	<div class="admin-form-section">
		<div class="admin-form-wrapper animate__animated" data-animation="animate__fadeInUp">
            <h2>Instructor Account Details</h2>
            <form action="/Drivingmitra/Trainer_account" method="post">
                <div class="form-group-admin">
                    <label for="id">ID:</label>
                    <input type="text" id="id" name="id">
                    <span id="ajaxmsg" class="ajax-message"></span>
                </div>
                <div class="form-group-admin">
                ...
                <div class="form-group-admin">
                    ...
                    <input type="text" id="name" name="name" oninput="validateName(event)">
                </div>
                <div class="form-group-admin">
                ...
                <div class="form-group-admin">
                    ...
                    <input type="text" id="phone" name="phone" maxlength="10" oninput="validatePhone(event)">
                </div>
                <div class="form-group-admin">
                    <label for="experience">Experience (Years):</label>
                    <input type="text" id="experience" name="experience" oninput="validateNumber(event)">
                </div>
                <div class="form-group-admin">
                    <label>Gender:</label>
                    <div>
    ...
    $("#id").on("input", function(){
        ...
        if(Trainer_id.length > 0) {
            $.ajax({
                ...
                error: function() {
                    ajaxMsgSpan.text("Error checking ID availability.").addClass('ajax-error').removeClass('ajax-success');
                }
            });
        } else {
            ajaxMsgSpan.text("").removeClass('ajax-success ajax-error');
        }
    });
...
function validateNumber(event) {
    ...
    if (sanitizedValue !== value) {
        input.value = sanitizedValue;
        alert("Only digits allowed for Experience");
    }
}
</script>
