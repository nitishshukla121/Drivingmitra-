...
<body style="background-color: #A7C7E7;">
    ...
    <div class="admin-hero-container view-feedback-hero">
        <div class="admin-hero-content">
            <h1 class="admin-hero-title animate__animated animate__fadeInDown">View Feedback</h1>
            <p class="admin-hero-subtitle animate__animated animate__fadeInUp animate__delay-0.5s">See what users are saying about us.</p>
        </div>
    </div>
	...
	<div class="admin-table-section">
		...
		<table class="admin-table">
			...
			%>
			<tr>
				<td><%=contact.getUser_name()%></td>
				<td><%=contact.getUser_email()%></td>
				<td><%=contact.getUser_phone()%></td>
				<td><%=contact.getUser_question()%></td>
			</tr>
			<%
			}
			%>
