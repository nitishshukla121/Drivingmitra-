...
<title>Add Event - Driving School Arena</title>
...
.form-group-admin input[type="date"]:focus,
...
<body style="background-color: #A7C7E7;">
    ...
    <div class="admin-hero-container">
        <div class="admin-hero-content">
            <h1 class="admin-hero-title animate__animated animate__fadeInDown">Add New Event</h1>
            <p class="admin-hero-subtitle animate__animated animate__fadeInUp animate__delay-0.5s">Schedule and manage upcoming events.</p>
        </div>
    </div>
