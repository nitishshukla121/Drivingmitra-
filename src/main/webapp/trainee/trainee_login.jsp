...
<title>Trainee Login - Driving School Arena</title>
...
.trainee-login-hero { /* Specific gradient for Trainee Login page hero */
...
/* --- Form Page Container (for Trainee Login) --- */
...
<body style="background-color: #C19A6B;">
    ...
    <!-- Hero Section for Trainee Login Page -->
    <div class="page-hero-container trainee-login-hero">
        <div class="hero-content">
            <h1 class="page-hero-title animate__animated animate__fadeInDown">Trainee Login</h1>
            <p class="page-hero-subtitle animate__animated animate__fadeInUp animate__delay-0.5s">Access your learning portal.</p>
        </div>
    </div>
    ...
    <div class="form-page-container">
        <div class="form-wrapper animate__animated" data-animation="animate__fadeInUp">
            <h2 class="form-heading">Trainee Login Here</h2>
            
            <form method="post" action="/Drivingmitra/Trainee_login" novalidate class="needs-validation">
                <div class="form-group">
                    <label for="trainee-id">Login ID:</label>
                    <input type="text" name="Id" id="trainee-id" placeholder="Login ID" required>
                ...
                <%-- Display message from request attribute if available --%>
